...
![Lern Pfade-Sicherheits Wiedergabeliste](media/cg-security-playlist.png)
...
In der Kategorie "Produkte" wurde die Unterkategorie "Office 365 Basics" in die Kategorie "Microsoft 365 Basics" aktualisiert. Zurückgezogene Objekte in der Kategorie "Office 365 Basics" sind weiterhin verfügbar, wenn Sie zu einer benutzerdefinierten Wiedergabeliste hinzugefügt wurden.
...
Die Unterkategorie "Product\Microsoft Teams" wurde mit den folgenden Objekten aktualisiert. 
...
- Ändern handgeschriebener Freihandeingaben in Shapes, Text oder Mathematik in PowerPoint (neu)
...
Office 365 wurde in Microsoft 365 umbenannt. Die Namensänderung wird im gesamten Microsoft 365 Lern Pfade-Inhalt reflektiert. 
...
##### <a name="best-practices-for-collaborating-with-office-365-6-new-assets"></a>Bewährte Methoden für die Zusammenarbeit mit Office 365 (6 neue Objekte)
- Erste Schritte
- Freigeben
- Mitautor
- Chatten in Dateien
...
- Empfohlene Dateien
#### <a name="outlook-for-the-web"></a>Outlook für das Internet
- Kennenlernen von Outlook für das Internet
- Erstellen einer Antwort auf e-Mail
...
- Einrichten Ihres iPhone oder iPad wurde zum Intro zur OneDrive-Wiedergabeliste hinzugefügt.
- Aktivieren der OneDrive-Sicherung wurde der Wiedergabeliste Dateien verwalten mit OneDrive hinzugefügt.
