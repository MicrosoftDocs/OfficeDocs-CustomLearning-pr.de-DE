...
- Hybridbesprechungen
- Überlegungen zum hybriden Besprechungsraum
- Was vor, während und nach Hybridbesprechungen zu tun ist
- Planen effektiver Besprechungen
- Planen und Führen effektiver Besprechungen
- Interagieren Ihrer Zielgruppe vor, während und nach Hybridbesprechungen
- Prüfliste für Besprechungen
- Reduzieren von Besprechungsermüdung

#### <a name="create-inclusive-meeting-environments"></a>Erstellen von inklusiven Besprechungsumgebungen
- Erstellen von inklusiven Besprechungsumgebungen
- Machen Sie Besprechungen und verwandte Inhalte für alle zugänglich
- Einschränken von Ablenkungen in Besprechungen
- Erstellen von Empathie in verschiedenen Zeitzonen
...
- Verwenden von Dokumentbibliotheken in SharePoint
- Problembehandlung bei häufigen Fehlern bei der gemeinsamen Erstellung

#### <a name="reach-large-audiences-with-live-events"></a>Erreichen großer Zielgruppen mit Liveereignissen
- Verwenden von Liveereignissen zum Erreichen großer Zielgruppen
- Erste Schritte mit Microsoft Teams für Liveereignisse
...
#### <a name="manage-team-schedules-with-shifts"></a>Verwalten von Teamzeitplänen mit Schichten
Die Teamzeitpläne mit der Wiedergabeliste "Schichten verwalten" wurde mit den folgenden Ressourcen hinzugefügt.
- Was ist Shifts
- Schichten für Manager
- Erstellen eines Schichtplans
- Verwalten eines Schichtzeitplans
...
#### <a name="create-approvals"></a>Erstellen von Genehmigungen
Die Genehmigungslisten erstellen wurde mit den folgenden Ressourcen hinzugefügt.
- Was sind Genehmigungen?
- Erstellen einer Genehmigung
- Erstellen einer Genehmigung aus einem Chat

### <a name="lists"></a>Listen
Den Lernpfaden wurde eine neue Listenunterkategorie und Wiedergabeliste hinzugefügt.
...
- Suchen und Verwalten Ihrer Liste
- Freigeben eines Listen- oder Listenelements
- Nachverfolgen von Geschäftsinformationen

### <a name="forms"></a>Formulare
Die Wiedergabeliste Formular erstellen und Ergebnisse anzeigen wurde mit den folgenden neuen Ressourcen aktualisiert.

#### <a name="create-a-form-and-view-results"></a>Erstellen eines Formulars und Anzeigen von Ergebnissen
- Erstellen eines neuen Formulars oder Quiz
- Freigeben eines Formulars zum Erhalten von Antworten
- Anzeigen der Ergebnisse Ihres Formulars
- Verwenden von Verzweigungslogik in Ihrem Formular
- Hinzufügen von Abschnitten zu Ihrer Umfrage oder Ihrem Fragebogen
...
Den Lernpfaden mit den folgenden Ressourcen wurde eine neue Wiedergabeliste für verknüpfte Datentypen hinzugefügt. 
- Konvertieren von Text in einen Organisationsdatentyp
- Angeben von Organisationsdatentypen mithilfe der Datenauswahl
- Anzeigen und Einfügen von Daten aus einem Organisationsdatentyp

#### <a name="formulas-and-functions"></a>Formeln und Funktionen
Der Wiedergabeliste "Formeln und Funktionen" wurden zwei neue Objekte hinzugefügt.
- XLOOKUP-Funktion
- VERGLEICH-Funktion
...
## <a name="september-2020-content-updates"></a>Inhaltsupdates vom September 2020
Im Folgenden sind die Inhaltsupdates für September 2020 aufgeführt. 
